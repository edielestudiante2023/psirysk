<div class="pdf-page portada">
    ...
    <!-- Header con logos -->
    <div class="pdf-header" style="border-bottom: none; margin-bottom: 30px; display: flex; justify-content: center; align-items: center; gap: 80px; padding: 0 20px;">
        <?php if ($logoCycloid): ?>
            <img src="<?= $logoCycloid ?>" alt="Cycloid" style="height: 70px; width: auto;">
        <?php endif; ?>

        <?php if ($logoRps): ?>
            <img src="<?= $logoRps ?>" alt="RPS" style="height: 90px; width: auto;">
        <?php endif; ?>
    </div>
