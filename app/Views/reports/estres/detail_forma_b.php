        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb" class="no-print">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mapa de Calor Estrés - Forma B</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-danger text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1">
                                <i class="fas fa-heartbeat me-2"></i>Mapa de Calor - Estrés Forma B
                            </h4>
                            <p class="mb-0 small">Cuestionario para la Evaluación del Estrés - Auxiliares y Operarios</p>
                        </div>
                        <div class="text-end">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0 text-danger">
                        <i class="fas fa-fire me-2"></i>Nivel de Estrés - Forma B
                    </h5>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header bg-info text-white">
                            <h6 class="mb-0">Nivel de Estrés Total - Forma B</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <p class="mb-0 small">Tabla 24<br>Resolución 2404/2019</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <div class="alert alert-success">
                                ...
                                <p class="mb-0 small">Este puntaje se compara con el baremo (Tabla 24) para determinar el nivel de estrés.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning mt-3 mb-0">
                        ...
                        <p class="mb-0 small">
                            ...
                            <strong><?= $calculations['estres_total']['total_trabajadores'] ?> trabajadores</strong> evaluados con la Forma B.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-table me-2"></i>Baremo Oficial - Forma B
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">6.6 - 11.8</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">11.9 - 17.0</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">17.1 - 23.4</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">23.5 - 100.0</td>
            ...
            <div class="alert alert-info">
                ...
                <ul class="mb-0 small">
                    <li><strong>Instrumento:</strong> Cuestionario para la evaluación del estrés - Forma B (31 preguntas)</li>
                    <li><strong>Aplicación:</strong> Auxiliares, operarios (mismo cuestionario que Forma A, pero con baremos diferentes)</li>
                    <li><strong>Baremo:</strong> Tabla 24 de la Resolución 2404 de 2019</li>
                    <li><strong>Cálculo:</strong> Promedio aritmético de los puntajes transformados de todos los trabajadores evaluados con Forma B</li>
            ...
            <div class="d-flex justify-content-between mb-4 no-print">
                ...
                <div>
                    <a href="<?= base_url('reports/estres-a/' . $service['id']) ?>" class="btn btn-outline-primary me-2">
