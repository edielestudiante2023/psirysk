...
<head>
    ...
    <style>
        ...
        /* Botones de colapso con fondo azul - texto blanco */
    ...
    <div class="result-container">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0"><i class="fas fa-user me-2"></i>Información del Trabajador</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Tipo de Cuestionario:</strong> Forma <?= $worker['intralaboral_type'] ?></p>
        ...
        <!-- Resultados Intralaborales -->
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0"><i class="fas fa-building me-2"></i>FACTORES INTRALABORALES</h3>
            </div>
            <div class="card-body">
                <h5 class="mb-3">Dominios y Dimensiones – Factores de Riesgo Psicosocial Intralaboral</h5>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseDominio1" class="accordion-collapse collapse show" aria-labelledby="headingDominio1" data-bs-parent="#accordionIntralaboral">
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    <?php if (isset($results['dim_caracteristicas_liderazgo_puntaje'])): ?>
                                    ...
                                    <?php if (isset($results['dim_relaciones_sociales_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_retroalimentacion_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_relacion_colaboradores_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                            <h6>Relación con los colaboradores</h6>
                                            <div class="score-value"><?= number_format($results['dim_relacion_colaboradores_puntaje'], 1) ?></div>
                                            <span class="nivel-badge <?= str_replace('_', '-', $results['dim_relacion_colaboradores_nivel']) ?>">
                                                <?= strtoupper(str_replace('_', ' ', $results['dim_relacion_colaboradores_nivel'])) ?>
                                            </span>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseDominio2" class="accordion-collapse collapse" aria-labelledby="headingDominio2" data-bs-parent="#accordionIntralaboral">
                            <div class="accordion-body">
                                <h6 class="mb-3 text-muted">Dimensiones</h6>
                                <div class="row">
                                    <?php if (isset($results['dim_claridad_rol_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_capacitacion_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                            <h6>Capacitación</h6>
                                    ...
                                    <?php if (isset($results['dim_participacion_manejo_cambio_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_oportunidades_desarrollo_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_control_autonomia_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                        ...
                        <div id="collapseDominio3" class="accordion-collapse collapse" aria-labelledby="headingDominio3" data-bs-parent="#accordionIntralaboral">
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    ...
                                    <?php if (isset($results['dim_demandas_ambientales_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_demandas_emocionales_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_demandas_cuantitativas_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_influencia_trabajo_entorno_extralaboral_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_demandas_responsabilidad_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                            <h6>Exigencias de responsabilidad del cargo</h6>
                                            <div class="score-value"><?= number_format($results['dim_demandas_responsabilidad_puntaje'], 1) ?></div>
                                            <span class="nivel-badge <?= str_replace('_', '-', $results['dim_demandas_responsabilidad_nivel']) ?>">
                                                <?= strtoupper(str_replace('_', ' ', $results['dim_demandas_responsabilidad_nivel'])) ?>
                                            </span>
                                        </div>
                                    </div>
                                    <?php endif; ?>

                                    <?php if (isset($results['dim_demandas_carga_mental_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['dim_consistencia_rol_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                            <h6>Consistencia del rol</h6>
                                            <div class="score-value"><?= number_format($results['dim_consistencia_rol_puntaje'], 1) ?></div>
                                            <span class="nivel-badge <?= str_replace('_', '-', $results['dim_consistencia_rol_nivel']) ?>">
                                                <?= strtoupper(str_replace('_', ' ', $results['dim_consistencia_rol_nivel'])) ?>
                                            </span>
                                        </div>
                                    </div>
                                    <?php endif; ?>

                                    <?php if (isset($results['dim_demandas_jornada_trabajo_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                        ...
                        <div id="collapseDominio4" class="accordion-collapse collapse" aria-labelledby="headingDominio4" data-bs-parent="#accordionIntralaboral">
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    ...
                                    <?php if (isset($results['dim_recompensas_pertenencia_puntaje'])): ?>
                                    ...
                                    <?php if (isset($results['dim_reconocimiento_compensacion_puntaje'])): ?>
                                    <div class="col-md-6 mb-3">
                                        <div class="score-box">
                ...
                <div class="card mb-3">
                    ...
                    <div id="collapseExtralaboral" class="collapse">
                        <div class="card-body">
                                <h6 class="mb-3 text-muted">Dimensiones</h6>
                                <div class="row">
                                    <?php if (isset($results['extralaboral_tiempo_fuera_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_relaciones_familiares_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_comunicacion_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_situacion_economica_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_caracteristicas_vivienda_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_influencia_entorno_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
                                    ...
                                    <?php if (isset($results['extralaboral_desplazamiento_puntaje'])): ?>
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box">
            ...
            <div id="calculosDetalle" class="collapse">
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        Los cálculos se realizan según la metodología oficial de la Batería de Riesgo Psicosocial del Ministerio de la Protección Social de Colombia.
                    </div>
                    ...
                    <h5 class="mt-4">Cálculo del Estrés</h5>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                <td><strong>Cuestionario:</strong></td>
                                <td>Escala de Estrés (31 preguntas)</td>
                            </tr>
                            <tr>
                                <td><strong>Escala de Respuesta:</strong></td>
                                <td>
                                    0 = Siempre<br>
                                    3 = Casi siempre<br>
                                    6 = Algunas veces<br>
                            ...
                            <tr>
                                <td><strong>Puntaje Bruto:</strong></td>
                                <td>Suma de todas las respuestas (0-279 puntos)</td>
                            </tr>
                            <tr class="table-primary">
                                <td><strong>Fórmula de Transformación:</strong></td>
                                <td>(Puntaje Bruto / 279) × 100</td>
                            </tr>
                            <tr class="table-success">
                                <td><strong>Puntaje Transformado:</strong></td>
                                <td><strong><?= number_format($results['estres_total_puntaje'] ?? 0, 1) ?></strong></td>
                            </tr>
                            <tr>
                                <td><strong>Nivel de Estrés:</strong></td>
                                <td>
                                    <?php
                                    $nivelEstres = $results['estres_total_nivel'] ?? 'N/A';
                                    $nivelTexto = [
                                        'muy_bajo' => 'Muy Bajo',
                                        'bajo' => 'Bajo',
                                        'medio' => 'Medio',
                                    ...
                                    echo '<span class="badge bg-' . ($nivelEstres == 'muy_bajo' || $nivelEstres == 'bajo' ? 'success' : ($nivelEstres == 'medio' ? 'warning' : 'danger')) . '">';
                                    echo $nivelTexto[$nivelEstres] ?? $nivelEstres;
                                    echo '</span>';
                                    ?>
                                </td>
                            </tr>
                    ...
                    <p><strong>Tipo de Cuestionario:</strong> Forma <?= $worker['intralaboral_type'] ?> (<?= $worker['intralaboral_type'] == 'A' ? 'Jefes, Profesionales, Técnicos' : 'Auxiliares, Operarios' ?>)</p>
                    <p><strong>Tipo de Posición:</strong> <?= esc($demographics['position_type'] ?? 'N/A') ?></p>
                    <p class="text-muted mt-3"><small><i class="fas fa-info-circle me-1"></i>Los baremos (tablas de interpretación) varían según el tipo de cargo del trabajador.</small></p>
                </div>
            </div>
        </div>
