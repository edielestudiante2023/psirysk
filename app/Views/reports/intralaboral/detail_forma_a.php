...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Intralaboral Forma A</li>
                </ol>
            </nav>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        ...
                        <span class="ms-3"><i class="fas fa-users me-1"></i><?= $totalWorkers ?> trabajadores evaluados con Forma A</span>
                    </p>
                </div>
                <?php
                $userRole = session()->get('role_name');
        ...
        <div class="col-12">
            <div class="card shadow-sm border-info">
                <div class="card-header bg-info text-white">
                    <h5 class="mb-0"><i class="fas fa-sitemap me-2"></i>Estructura del Cuestionario Intralaboral - Forma A</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled ms-3">
                                ...
                                <li>4. Relación con los colaboradores</li>
                            </ul>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled ms-3">
                                ...
                                <li>14. Exigencias de responsabilidad del cargo</li>
                                <li>15. Demandas de carga mental</li>
                                <li>16. Consistencia del rol</li>
                    ...
                    <div class="alert alert-warning mt-3 mb-0">
                        <small><i class="fas fa-info-circle me-1"></i><strong>Nota:</strong> La Forma A tiene 19 dimensiones distribuidas en 4 dominios. Esta forma se aplica a jefes, profesionales y técnicos que tienen personal a cargo o alta responsabilidad.</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-th me-2"></i>Mapa de Calor Intralaboral - Forma A</h5>
                </div>
                        ...
                        <div class="d-flex flex-column" style="width: 80%;">
                            ...
                            <div class="d-flex" style="flex: 1; border-bottom: 2px solid white;">
                                ...
                                <div class="d-flex flex-column" style="width: 75%;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_retroalimentacion']['nivel']) ?>; color: white; border-bottom: 1px solid white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_relacion_colaboradores']['nivel']) ?>; color: white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Relación con los colaboradores</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_relacion_colaboradores']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex" style="flex: 1; border-bottom: 2px solid white;">
                                ...
                                <div class="d-flex flex-column" style="width: 75%;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_participacion_manejo_cambio']['nivel']) ?>; color: white; border-bottom: 1px solid white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Participación y manejo del cambio</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_participacion_manejo_cambio']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex" style="flex: 1; border-bottom: 2px solid white;">
                                ...
                                <div class="d-flex flex-column" style="width: 75%;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_influencia_trabajo_entorno_extralaboral']['nivel']) ?>; color: white; border-bottom: 1px solid white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Influencia del trabajo sobre el entorno extralaboral</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_influencia_trabajo_entorno_extralaboral']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_demandas_responsabilidad']['nivel']) ?>; color: white; border-bottom: 1px solid white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Exigencias de responsabilidad del cargo</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_demandas_responsabilidad']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_consistencia_rol']['nivel']) ?>; color: white; border-bottom: 1px solid white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Consistencia del rol</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_consistencia_rol']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center p-2" style="flex: 1; background-color: <?= getNivelColor($calculations['dim_demandas_jornada_trabajo']['nivel']) ?>; color: white;">
                                        <div class="text-center" style="font-size: 0.75rem;">
                                            <div style="font-weight: 600;">Demandas de la jornada de trabajo</div>
                                            <div style="font-size: 1.2rem; font-weight: bold; margin-top: 3px;"><?= number_format($calculations['dim_demandas_jornada_trabajo']['promedio'], 1) ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- CARDS DE CÁLCULOS (24 total: 1 total + 4 dominios + 19 dimensiones) -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>Con un puntaje de <strong><?= number_format($calculations['intralaboral_total']['promedio'], 2) ?></strong>, según la Tabla 33 (Forma A), el nivel de riesgo es:</p>
                        ...
                        <div class="col-md-6">
                            <h6>Baremo Aplicado (Tabla 33 - Forma A):</h6>
    ...
    <!-- DIMENSIONES (19 cards) -->
    <div class="row mb-3">
        <div class="col-12"><h5 class="text-success"><i class="fas fa-puzzle-piece me-2"></i>DIMENSIONES (19 para Forma A)</h5></div>
    </div>
    ...
    $dimensiones = [
        ...
        ['key' => 'dim_relacion_colaboradores', 'nombre' => 'Relación con los colaboradores', 'dominio' => 'Liderazgo'],
        ['key' => 'dim_claridad_rol', 'nombre' => 'Claridad de rol', 'dominio' => 'Control'],
        ['key' => 'dim_capacitacion', 'nombre' => 'Capacitación', 'dominio' => 'Control'],
        ['key' => 'dim_participacion_manejo_cambio', 'nombre' => 'Participación y manejo del cambio', 'dominio' => 'Control'],
        ...
        ['key' => 'dim_influencia_trabajo_entorno_extralaboral', 'nombre' => 'Influencia del trabajo sobre el entorno extralaboral', 'dominio' => 'Demandas'],
        ['key' => 'dim_demandas_responsabilidad', 'nombre' => 'Exigencias de responsabilidad del cargo', 'dominio' => 'Demandas'],
        ['key' => 'dim_demandas_carga_mental', 'nombre' => 'Demandas de carga mental', 'dominio' => 'Demandas'],
        ['key' => 'dim_consistencia_rol', 'nombre' => 'Consistencia del rol', 'dominio' => 'Demandas'],
        ['key' => 'dim_demandas_jornada_trabajo', 'nombre' => 'Demandas de la jornada de trabajo', 'dominio' => 'Demandas'],
    ...
    <div class="row mt-4 mb-4">
        <div class="col-12">
            <div class="alert alert-info">
                ...
                <p class="mb-0">Los cálculos se realizan utilizando el <strong>promedio aritmético</strong> de los puntajes transformados de todos los trabajadores evaluados con Forma A. Los baremos aplicados corresponden a las tablas oficiales de la Resolución 2404 de 2019: Tabla 33 para Total Intralaboral Forma A, Tabla 31 para Dominios, y Tabla 29 para las 19 Dimensiones de Forma A.</p>
            </div>
        </div>
    </div>
