...
class Email extends BaseConfig
{
    ...
    public function __construct()
    {
        ...
        // Load SendGrid configuration from .env
        $this->fromEmail = env('email.fromEmail', 'noreply@psyrisk.com');
        $this->fromName = env('email.fromName', 'PsyRisk');
        $this->protocol = env('email.protocol', 'smtp');
        $this->SMTPHost = env('email.SMTPHost', 'smtp.sendgrid.net');
        $this->SMTPUser = env('email.SMTPUser', 'apikey');
