...
class IntralaboralB
{
    ...
    public static $sectionHeaders = [
        ...
        13 => 'Para responder a las siguientes preguntas piense en la cantidad de trabajo que usted tiene a cargo.',
        16 => 'Las siguientes preguntas están relacionadas con el esfuerzo mental que le exige su trabajo.',
        21 => 'Las siguientes preguntas están relacionadas con la jornada de trabajo.',
        29 => 'Las siguientes preguntas están relacionadas con las decisiones y el control que le permite su trabajo.',
        38 => 'Las siguientes preguntas están relacionadas con cualquier tipo de cambio que ocurra en su trabajo.',
        41 => 'Las siguientes preguntas están relacionadas con la información que la empresa le ha dado sobre su trabajo.',
        46 => 'Las siguientes preguntas están relacionadas con la formación y capacitación que la empresa le facilita para hacer su trabajo.',
        49 => 'Las siguientes preguntas están relacionadas con el o los jefes con quien tenga más contacto.',
        62 => 'Las siguientes preguntas indagan sobre las relaciones con otras personas y el apoyo entre las personas de su trabajo.',
        74 => 'Las siguientes preguntas están relacionadas con la información que recibe sobre su rendimiento en el trabajo.',
        79 => 'Las siguientes preguntas están relacionadas con la satisfacción, reconocimiento y la seguridad que le ofrece su trabajo.'
    ];

    /**
     * Las 97 preguntas del cuestionario Intralaboral Forma B
     * Textos exactos del Ministerio de la Protección Social de Colombia
     */
    public static $questions = [
        1 => 'El ruido en el lugar donde trabajo es molesto',
        2 => 'El ruido en el lugar donde trabajo es molesto',
    ...
    /**
     * Pregunta condicional de atención a clientes
     */
    public static $conditionalQuestion = [
        'number' => 'I',
        'text' => 'En mi trabajo debo brindar servicio a clientes o usuarios:',
        'options' => ['Sí', 'No'],
        'controls_questions' => [89, 90, 91, 92, 93, 94, 95, 96, 97]
    ];

    /**
     * Get conditional question
     */
    public static function getConditionalQuestion()
    {
        return self::$conditionalQuestion;
    }
