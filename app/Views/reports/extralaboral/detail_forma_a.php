...
<nav aria-label="breadcrumb" class="no-print">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Mapa de Calor Extralaboral - Forma A</li>
    </ol>
</nav>
...
<div class="card shadow-sm mb-4">
    <div class="card-header bg-info text-white">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="mb-1">
                    <i class="fas fa-home me-2"></i>Mapa de Calor - Extralaboral Forma A
                </h4>
                <p class="mb-0 small">Factores de Riesgo Psicosocial Fuera del Trabajo - Jefes, Profesionales, Técnicos</p>
            </div>
            <div class="text-end">
...
<div class="card shadow-sm mb-4 border-info">
    <div class="card-header bg-info text-white">
        <h5 class="mb-0"><i class="fas fa-sitemap me-2"></i>Estructura del Cuestionario Extralaboral - Forma A</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-12">
...
<div class="card shadow-sm mb-4">
    <div class="card-header bg-white border-bottom">
        <h5 class="mb-0 text-info">
            <i class="fas fa-fire me-2"></i>Mapa de Calor Extralaboral - Forma A
        </h5>
    </div>
...
<div class="d-flex justify-content-between mb-4 no-print">
    ...
    <div>
        <a href="<?= base_url('reports/extralaboral-b/' . $service['id']) ?>" class="btn btn-outline-primary me-2">
