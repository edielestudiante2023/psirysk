...
<body>
    ...
    <div class="result-container">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0">
                    ...
                    <span class="forma-badge">FORMA A - Jefes, Profesionales, Técnicos</span>
                </h3>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Tipo de Cuestionario:</strong> Forma A (123 preguntas)</p>
        ...
        <!-- Resultados Intralaborales FORMA A -->
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0"><i class="fas fa-building me-2"></i>FACTORES INTRALABORALES - FORMA A</h3>
            </div>
            <div class="card-body">
                <h5 class="mb-3">Dominios y Dimensiones – Factores de Riesgo Psicosocial Intralaboral (20 Dimensiones)</h5>
                        ...
                        <div id="collapseDominio1" class="accordion-collapse collapse show" aria-labelledby="headingDominio1" data-bs-parent="#accordionIntralaboral">
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Relación con los colaboradores (ESPECÍFICA FORMA A - JEFES) -->
                                    <div class="col-md-6 col-lg-3 mb-3">
                                        <div class="score-box" style="border-left-color: #28a745;">
                                            <h6>Relación con los colaboradores <span class="badge bg-success">Solo Jefes</span></h6>
            ...
            <div id="calculosDetalle" class="collapse">
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        Los cálculos se realizan según la metodología oficial de la Batería de Riesgo Psicosocial del Ministerio de la Protección Social de Colombia - <strong>Forma A (Jefes, Profesionales, Técnicos)</strong>.
                    </div>

                    <h5 class="mt-4">Especificaciones Forma A</h5>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>20 dimensiones</td>
                            </tr>
                            <tr>
                                <td><strong>Dimensión exclusiva:</strong></td>
                                <td>"Relación con los colaboradores" (gestión de personal)</td>
                            </tr>
                            <tr>
                                <td><strong>Baremos aplicados:</strong></td>
                                <td>Baremos específicos Forma A según posición (jefe/profesional/técnico)</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <p><strong>Tipo de Cuestionario:</strong> Forma A (Jefes, Profesionales, Técnicos - 123 preguntas)</p>
                    <p><strong>Tipo de Posición:</strong> <?= esc($demographics['position_type'] ?? 'N/A') ?></p>
